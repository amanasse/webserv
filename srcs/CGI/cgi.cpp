...
/*   Updated: 2023/03/29 11:19:04 by amanasse         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
std::string Cgi::html_to_string(std::string value_error)
{
	if (value_error == "200 OK" || value_error == "301")
		...
		this->_value = "./srcs/CGI/errors/400.html";
	else if (value_error == "404")
	{
		...
		this->_value = "./srcs/CGI/errors/405.html";
	else if (value_error == "408")
		this->_value = "./srcs/CGI/errors/408.html";
	else if (value_error == "409")
		this->_value = "./srcs/CGI/errors/409.html";
	else if (value_error == "411")
		this->_value = "./srcs/CGI/errors/411.html";
	else if (value_error == "413")
		this->_value = "./srcs/CGI/errors/413.html";
	else if (value_error == "414")
		this->_value = "./srcs/CGI/errors/414.html";
	else if (value_error == "415")
		this->_value = "./srcs/CGI/errors/415.html";
	else if (value_error == "431")
		this->_value = "./srcs/CGI/errors/431.html";
	else if (value_error == "500")
		this->_value = "./srcs/CGI/errors/500.html";
	else if (value_error == "505")
		this->_value = "./srcs/CGI/errors/505.html";
	else if (this->getMethod() == "DELETE")
	{
		if (this->getStatus() == "404")
			this->_value = getErrorPage();
		else
			this->_value = "./srcs/CGI/html/Formulaire_delete.php";
	}
	else
